...
export function AnnouncementBar() {
  ...
  useEffect(() => {
    function handler(e: Event) {
      ...
      if (d.announcement_text !== undefined)
        setText(d.announcement_text as string);
      if (d.announcement_url !== undefined)
        setUrl(d.announcement_url as string);
      if (d.announcement_bg_color !== undefined)
        setBgColor(d.announcement_bg_color as string);
      if (d.announcement_text_color !== undefined)
        setTextColor(d.announcement_text_color as string);
