    ...
    "@graph": [
      // ── LocalBusiness / SportsActivityLocation ──────────────────────────
      {
        ...
        hasOfferCatalog: {
          ...
          itemListElement: [
            {
              "@type": "Offer",
              itemOffered: { "@type": "Service", name: "Vinyasa Flow Yoga" },
            },
            {
              "@type": "Offer",
              itemOffered: { "@type": "Service", name: "Pilates Reformer" },
            },
            {
              "@type": "Offer",
              itemOffered: { "@type": "Service", name: "Yin Yoga" },
            },
            {
              "@type": "Offer",
              itemOffered: {
            ...
            {
              "@type": "Offer",
              itemOffered: { "@type": "Service", name: "Barre" },
            },
          ],
        },
      },
      // ── WebSite ──────────────────────────────────────────────────────────
      {
        ...
        potentialAction: {
          ...
          target: {
            "@type": "EntryPoint",
            urlTemplate: `${BASE_URL}/classes?q={search_term_string}`,
          },
