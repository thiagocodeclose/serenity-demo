...
const DEFAULT_TITLE =
  "Serenity Wellness Studio | Yoga, Pilates & Meditation · Austin, TX";
const DEFAULT_DESC =
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description,
    keywords: [
      "yoga studio santa monica",
      "pilates santa monica",
      "yoga classes santa monica",
      "wellness studio los angeles",
      "vinyasa flow santa monica",
      "pilates reformer santa monica",
      "yin yoga los angeles",
      "meditation classes santa monica",
      "hot yoga santa monica",
      "barre classes santa monica",
      "yoga studio near me",
      "pilates near me",
    ],
